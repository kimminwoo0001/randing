    ...
    <article className="section section__3">
      <section className="container">
        ...
        <section className="section__3__subtitle">
          <div className="section__3__subtitle__text">
            <span className="section__3__subtitle__label">
              <img className="icon" src="/images/icon/ico_title_1.svg" alt="" />
              갱킹/로밍 지표
            </span>
            <h3>
              갱킹성공률
        ...
        <section className="section__3__subtitle ">
          <div className="section__3__subtitle__text">
            <span className="section__3__subtitle__label">
              <img className="icon" src="/images/icon/ico_title_2.svg" alt="" />
              교전 지표
            </span>
            <h3>
              교전 참여율
        ...
        <section className="section__3__subtitle">
          <div className="section__3__subtitle__text">
            <span className="section__3__subtitle__label">
              <img className="icon" src="/images/icon/ico_title_3.svg" alt="" />
              라인전 지표
            </span>
            <h3>
              갱 호응 성공률
        ...
        <section className="section__3__subtitle">
          <div className="section__3__subtitle__text">
            <span className="section__3__subtitle__label">
              <img className="icon" src="/images/icon/ico_title_4.svg" alt="" />
              교전 지표
            </span>
            <h3>
              라인별 시팅 지수

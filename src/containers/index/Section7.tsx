    ...
    <article className="section section__7">
      ...
      <section className="section__container">
        <div className="section__7__desc">
          <h4>성향지표</h4>
          <p>
            팀과 선수의 성향에 관한 지표를 제공합니다. 우리 팀의 성향을 파악하여
            부족한 선수 성향을 찾고 그것을 보완할 수 있는 선수들을 발굴하여
            영입에 반영할 수 있습니다.
          </p>
        </div>
        ...
        <div className="section__7__desc">
          ...
          <p>
            ...
            역할과 관계없이 성적을 잘 평가 할 수 있는 PR 지표를 제공합니다. 또한
            추세 분석을 통해 성장 중인지, 어떤 메타에서 잘했는지 등을 분석하여
            제공합니다.
          </p>
        </div>
      </section>
